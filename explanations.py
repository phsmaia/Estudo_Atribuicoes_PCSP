    ...
    if language == "EN":
        explanations_en = {
            "tecnico": {
                ...
                "mode_1_catalog": "**📖 Scientific Comprehension: Complete Assignments Catalog**\n\nRaw tabular view of the dataset without dimensionality reduction.\n- **Purpose:** Allows the auditing of the raw legal texts that feed the analytical matrices. Presents the exact textual transcription of the norms.",
                "mode_1_conversion": "**📖 Scientific Comprehension: Diachronic Role Conversion**\n\nStructural mapping table that tracks nomenclature shifts across different legislative eras.\n- **Purpose:** Essential for aligning historical data (e.g. from 1967) with contemporary structures, ensuring that metrics like Gower Distance compare the correct evolutionary lineages."
            },
            "leigo": {
                ...
                "mode_1_catalog": "**💡 Simplified Explanation: Complete Assignments Catalog**\n\nIt is the raw library of all the texts from the laws and notices.\n- **How to read:** Use the filters to find exactly what a role does according to a specific law. This is the raw material used to build all the charts in the system.",
                "mode_1_conversion": "**💡 Simplified Explanation: Role Conversion Table**\n\nA translation guide for old job titles.\n- **How to read:** If you see a weird role name from 1967 and don't know what it is today, look it up here. It shows what happened to each role over the decades."
            }
        }
