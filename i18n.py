...
TRANSLATIONS = {
    "PT-BR": {
        ...
        "tut_sec_dendro": "O Dendrograma ilustra a hierarquia de similaridade. Cargos que se unem mais cedo (mais abaixo/esquerda) são funcionalmente mais parecidos.",
    ...
    "EN": {
        ...
        "tut_sec_dendro": "The Dendrogram illustrates the hierarchy of similarity. Roles that merge earlier are functionally more alike.",
